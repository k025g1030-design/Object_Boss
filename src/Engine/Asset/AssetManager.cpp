...
namespace Asset {
    void AssetManager::Initialize(const std::string& catalogPath) {
        ...
        RegisterLoader<AnimationData>(AssetType::ClipData, std::make_shared<AnimationLoader>());
        RegisterLoader<TileSetData>(AssetType::MapTiledData, std::make_shared<TileSetLoader>());
    }
